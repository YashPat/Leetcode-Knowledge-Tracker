...
Personal macOS app for tracking everything that is important to me. 

Current features:
- Spaced repetition over Leetcode categories (FSRS-scheduled)
- Generic Daily Habit tracking (will use a github heatmap, supports adding/removing new habits)
- Eventually may support new views/tabs to track more
- Will use SwiftData, but also want to support export/import of data
